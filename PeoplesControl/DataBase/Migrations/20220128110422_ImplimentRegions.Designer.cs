...
namespace DataBase.Migrations
{
    ...
    [Migration("20220128110422_ImplimentRegions")]
    partial class ImplimentRegions
    {
            ...
            modelBuilder.Entity("DataBase.Models.ActionMeta", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            Date = new DateTime(2022, 1, 28, 14, 4, 21, 713, DateTimeKind.Local).AddTicks(6743)
                        },
                        new
                        {
                            Id = 2L,
                            Date = new DateTime(2022, 1, 28, 14, 4, 21, 715, DateTimeKind.Local).AddTicks(5787)
                        },
                        new
                        {
                            Id = 3L,
                            Date = new DateTime(2022, 1, 28, 14, 4, 21, 715, DateTimeKind.Local).AddTicks(6040)
                        });
                });

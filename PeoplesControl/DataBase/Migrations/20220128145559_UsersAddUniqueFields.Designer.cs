...
namespace DataBase.Migrations
{
    ...
    [Migration("20220128145559_UsersAddUniqueFields")]
    partial class UsersAddUniqueFields
    {
            ...
            modelBuilder.Entity("DataBase.Models.ActionMeta", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            Date = new DateTime(2022, 1, 28, 17, 55, 58, 407, DateTimeKind.Local).AddTicks(1152)
                        },
                        new
                        {
                            Id = 2L,
                            Date = new DateTime(2022, 1, 28, 17, 55, 58, 408, DateTimeKind.Local).AddTicks(1661)
                        },
                        new
                        {
                            Id = 3L,
                            Date = new DateTime(2022, 1, 28, 17, 55, 58, 408, DateTimeKind.Local).AddTicks(1685)
                        });
                });
